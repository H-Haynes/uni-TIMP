...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent({
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return {
        a: common_vendor.sr(loadingRef, "d4ef0472-0", {
          "k": "loadingRef"
        }),
        b: common_vendor.p({
          mask: "true",
        ...
        k: common_vendor.f(songList.value, (song, k0, i0) => {
          return {
            ...
            e: "d4ef0472-6-" + i0 + "," + ("d4ef0472-5-" + i0),
            f: "d4ef0472-7-" + i0 + "," + ("d4ef0472-5-" + i0),
            g: song.id,
            h: "d4ef0472-5-" + i0 + ",d4ef0472-1"
          };
        }),
        l: common_vendor.p({
          align: "right"
