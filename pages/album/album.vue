	...
	<view class="h-full flex flex-col">
		...
		<view class="flex-1 overflow-y-scroll">
			<uni-table stripe emptyText="暂无更多数据">
				<uni-tr class="flex p-2 justify-between text-base bg-gray-100">
						<uni-th align="left">歌曲</uni-th>
						<uni-th align="right" class="w-24">操作</uni-th>
				</uni-tr>
				<uni-tr v-for="song in songList" :key="song.id"  class="flex border-b p-2">
						<uni-td class="flex-1">
						...
						<uni-td align="right">
							<text class="text-gray-400 inline-block iconfont icon-gengduomore10  mr-2"></text>
						</uni-td>
				</uni-tr>
			</uni-table>
		</view>
